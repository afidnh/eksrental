...
$minsewa=$_POST['minsewa'];
$harga=$_POST['harga'];
$awal = strtotime($_POST['fromdate']);
$akhir = strtotime($_POST['todate']);
$diff  = $akhir - $awal;
...
if ($jam >= $minsewa) {
  $sql="INSERT INTO  tblbooking(userEmail,VehicleId,FromDate,ToDate,message,Status,SubHarga) VALUES(:useremail,:vhid,:fromdate,:todate,:message,:status,:subharga)";
    ...
    if($lastInsertId)
      ...
      echo "<script>alert('Di Bawah Minimal Jam Sewa. Please try again');</script>";
    }
}
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Term and Condition </a></li>
          
             <!--  <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">Perlengkapan</a></li> -->
            </ul>
            ...
            <div class="tab-content"> 
              ...
              <div role="tabpanel" class="tab-pane active" id="vehicle-overview">
                ...
                <p><?php echo htmlentities($result->ketentuan);?></p>
              </div>
            </div>
          </div>
...
$harga=$result->harga;
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              <input type="datetime-local" class="form-control" name="fromdate" placeholder="Start Date" required>
            </div>
            <div class="form-group">
              <input type="datetime-local" class="form-control" name="todate" placeholder="End Date" required>
              <input type="hidden" name="minsewa" value="<?php echo $sewa;?>">
            ...
            <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
              <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Masuk Untuk Booking</a>
              <?php } ?>
          </form>
        </div>
      </aside>
    ...
    <div class="similar_cars">
      ...
      <?php 
      $bid=$_SESSION['brndid'];
      $sql="SELECT tblvehicles.nama,tblbrands.BrandName,tblvehicles.harga,tblvehicles.kapasitas,tblvehicles.ModelYear,tblvehicles.id,tblvehicles.MinSewa,tblvehicles.ketentuan,tblvehicles.Vimage1 from tblvehicles join tblbrands on tblbrands.id=tblvehicles.kategori where tblvehicles.kategori=:bid";
      $query = $dbh -> prepare($sql);
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              <h5><a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->nama);?></a></h5>
              <p class="list-price">$<?php echo htmlentities($result->harga);?></p>
          
              <ul class="features_list">
                
             <li><i class="fa fa-cogs" aria-hidden="true"></i><?php echo htmlentities($result->kapasitas);?> Ton / M</li>
                <li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> model</li>
                <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->MinSewa);?> Jam</li>
              </ul>
            </div>
          </div>
        </div>
