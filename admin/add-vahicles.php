...
{ 
  ...
  <head>
    ...
    <title>Heavy Equipment | Create Vehicles</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-pencil"></i>Tambah Alat Berat</h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              ...
              <form method="post" enctype="multipart/form-data" action="proses-add-vahicles.php">
                <h3 class="tile-title">Basic Info</h3>
                <br/>
                <div class="row">
                  <div class="col-6">
                    <input type="text" class="form-control" name="nama" placeholder="Nama Alat Berat" required="">
                  </div>
                  <div class="col-6">
                  ...
                  <div class="row">
                    <div class="col-6">
                      <input type="text" class="form-control" name="harga" placeholder="Price Per Jam (Rp)" required="">
                    </div>
                    <div class="col-6">
                      <input type="text" class="form-control" name="kapasitas" placeholder="Kapasitas Berat (Ton)" required="">
                    </div>
                  </div>
                  <br/>
                  <div class="row">
                    ...
                    <div class="col-6">
                      <input type="text" class="form-control" name="sewa" placeholder="Min Sewa (Jam)" required="">
                    </div>
                  </div>
                  <br/>
                  <div class="row">
                    <div class="col-12">
                      <textarea class="form-control" name="ketentuan" rows="5" placeholder="overview" required=""></textarea>
                    </div>
                  </div>
                  <br/>
