...
// Code for change password 
  ...
  <head>
    ...
    <title>Utomo Rental | Update Contact Info</title>
    <meta charset="utf-8">
                  ...
                  foreach($results as $result)
                    {       ?>  
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label class="control-label">Kontak Nomer</label>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo htmlentities($result->NoBank);?>" name="norekening" id="norekening" required>
                      </div>
                      <div class="form-group">
                        <label class="control-label">Atas Nama (Nama Bank)</label>
                        <input type="text" class="form-control" value="<?php echo htmlentities($result->NamaBank);?>" name="namabank" id="namabank" required>
                      </div>
                    <?php }} ?>
                    <div class="form-group">
