...
{ 
  ...
  <head>
    ...
    <title>Utomo Rental | Manage Vehicles</title>
    <meta charset="utf-8">
            ...
            <div class="tile-body">
              ...
              <table id="example" class="display responsive nowrap" style="width:100%">
                ...
                <tbody>
                  ...
                  <?php $sql = "SELECT tblvehicles.nama,tblbrands.BrandName,tblvehicles.harga,tblvehicles.kapasitas,tblvehicles.MinSewa,tblvehicles.ModelYear,tblvehicles.id from tblvehicles join tblbrands on tblbrands.id=tblvehicles.kategori";
                  $query = $dbh -> prepare($sql);
                  $query->execute();
                    ...
                    foreach($results as $result)
                      {       ?>  
                        <tr>
                          ...
                          <td><?php echo htmlentities($result->MinSewa);?></td>
