...
<title>Utomo Rental | Heavy Equipment</title>
<!--Bootstrap -->
...
$brand=$_POST['brand'];
$sql = "SELECT id from tblvehicles where tblvehicles.kategori=:brand ";
...
$sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.kategori where tblvehicles.kategori=:brand";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Cari Alat Berat </h5>
          </div>
