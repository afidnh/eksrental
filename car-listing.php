...
<title>Utomo Rental | Daftar Alat Berat</title>
<!--Bootstrap -->
...
<?php $sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.kategori";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <ul>
              <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->kapasitas);?> Ton / M</li>
              <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> model</li>
              <li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->MinSewa);?> Jam</li>
            </ul>
...
if($query->rowCount() > 0)
{
  foreach($hasil as $hasil)
    { 
      $nohp=$hasil->ContactNo;
      if(substr(trim($nohp), 0, 1)=='0'){
             $hp = '62'.substr(trim($nohp), 1).'?text=Saya%20memiliki%20pertanyaan%20mengenai%20alatberat%20yang%20disewakan';
         }
 ?>
<!--Back to top-->
<div style="bottom: 5px; position: fixed; right:90px;"><a href="https://wa.me/<?php echo htmlentities($hp);?>" target="_blank"><img src="assets/images/whatsapp.png" style="width: 260px;"> </a></div><div id="back-top" class="back-top"> <a href="#top"><i class="fa fa-angle-up" aria-hidden="true"></i> </a></div>
<!--Login-Form -->
